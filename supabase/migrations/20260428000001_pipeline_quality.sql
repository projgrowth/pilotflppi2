...
--    Source: FBC 8th Edition (2023) — titles and requirement text are
...
('FBC', '1004.1',   '8th', 'Design Occupant Load',
...
('FBC', '1004.9',   '8th', 'Posting of Occupant Load',
...
('FBC', '1006.2.1', '8th', 'Single Exit — Space/Story Limits',
...
('FBC', '1007.1',   '8th', 'Exit and Exit Access Doorway Configuration',
...
('FBC', '1008.3',   '8th', 'Emergency Power for Illumination',
...
('FBC', '1013.1',   '8th', 'Where Required — Exit Signs',
...
('FBC', '1020.1',   '8th', 'Construction — Corridors',
...
('FBC', '1020.2',   '8th', 'Width — Corridors',
...
('FBC', '1023.2',   '8th', 'Enclosures — Interior Exit Stairways',
...
('FBC', '903.2',    '8th', 'Where Required — Automatic Sprinkler Systems',
...
('FBC', '905.3',    '8th', 'Where Required — Standpipe Systems',
 'Standpipe systems shall be provided in new buildings and structures in accordance with this section.'),

('FBC', '907.2',    '8th', 'Where Required — Fire Alarm and Detection Systems',
...
-- ── Occupancy (Ch. 3 / 5 / 6) ─────────────────────────────────────────────
('FBC', '508.1',    '8th', 'Mixed Occupancies',
...
('FBC', '505.2',    '8th', 'Mezzanines — Area Limitation',
...
('FBC', '403.1',    '8th', 'High-Rise Buildings',
...
-- ── Structural (Ch. 16) ────────────────────────────────────────────────────
('FBC', '1603.1',   '8th', 'Required Information on Construction Documents',
...
('FBC', '1609.1',   '8th', 'Applications — Wind Loads',
...
('FBC', '1612.1',   '8th', 'Construction in Flood Hazard Areas',
...
('FBC', '1705.1',   '8th', 'Special Inspections Required',
...
('FAC', '206.2.3',  '8th', 'Multi-Story Buildings — Elevator Requirement',
...
('FAC', '208.2',    '8th', 'Parking — Minimum Number',
...
('FAC', '404.2.4',  '8th', 'Doors — Maneuvering Clearances',
...
('FBC-EC', 'C402.1', '8th', 'Building Envelope — Opaque Element Insulation',
...
('FBC-EC', 'C402.4', '8th', 'Fenestration — Maximum Area and Performance',
...
('FBC-EC', 'C403.5', '8th', 'Economizers — HVAC',
...
('FBC-EC', 'C405.2', '8th', 'Interior Lighting — Automatic Controls',
...
('FBC-EC', 'C405.3', '8th', 'Interior Lighting Power',
...
('FBC-M', '401.1',  '8th', 'Ventilation — General',
...
('FBC-P', '608.1',  '8th', 'Backflow Prevention — General',
...
('FBC-P', '1003.1', '8th', 'Interceptors and Separators — General',
...
('FBC', '1609.2',   '8th', 'Protection of Openings — Wind-Borne Debris',
...
('FBC', '2405.5',   '8th', 'Skylights — Safety Glazing',
...
-- ── Special Inspections ───────────────────────────────────────────────────
('FBC', '1704.1',   '8th', 'Special Inspections — Statement of Special Inspections',
