...
import { useOptimisticFindingStatus } from "@/hooks/plan-review/useOptimisticFindingStatus";
...
export default function PlanReviewDetail() {
  ...
  const { findingStatuses, updateFindingStatus } = useOptimisticFindingStatus(
    review,
    user?.id,
    refetchHistory,
  );
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-0px)] overflow-hidden">
      <ReviewTopBar
        ...
        onBack={useCallback(() => navigate("/plan-review"), [navigate])}
